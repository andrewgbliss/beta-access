...
import RegisterDialog from 'components/Dialogs/Register/Register';
import ForgotPasswordDialog from 'components/Dialogs/ForgotPassword/ForgotPassword';
...
const LoginLink: React.FC = () => {
  ...
  return useObserver(() => {
    ...
    return (
      <Box pl={1}>
        <Button
          onClick={() => store.setOpenLoginDialog(true)}
          style={{ color: '#fff' }}
          component="a"
        >
          Login
